...
* **Pushgateway**: [localhost:9091](http://localhost:9091)\
  To specify another endpoint for the Pushgateway, use the [`Metrics.PushGatewayUrl`](../../developers/fundamentals/configuration.md#metrics-pushgatewayurl) configuration option.

### Step 3: Run Trust Green Chain

To enable metrics in Trust Green Chain, set the [`Metrics.Enabled`](../../developers/fundamentals/configuration.md#metrics-enabled) configuration option to `true`. For more options, see the [Metrics](../../developers/fundamentals/configuration.md#metrics) configuration section.
