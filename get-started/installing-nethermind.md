...
# Installing Trustgreen Chain

import Tabs from "@theme/Tabs"; import TabItem from "@theme/TabItem";

Trust Green Chain can be installed in several ways:

* [Via a package manager](installing-nethermind.md#package-managers)
* [As a standalone download](installing-nethermind.md#standalone-downloads)
* [As a Docker container](installing-nethermind.md#docker-container)
* [By building from source code](../developers/building-from-source.md)

### Prerequisites

:::info Does not apply to Docker distributions. :::
...
1.  Create a separate user and group for Trust Green Chain and configure them as follows:
    ...
    mkdir ~/data
    ```
2. [Download Trust Green Chain](installing-nethermind.md#standalone-downloads) and extract the package contents to the `~/bin` directory created in the previous step.
3.  Configure Trust Green Chain options in the `~/.env` file:
    ...
    For available options, see [Configuration](../developers/fundamentals/configuration.md).
...
:::tip It's highly recommended to mount data volumes as the Trust Green Chain's data directories to ensure the synced data is preserved between the container restarts. :::
